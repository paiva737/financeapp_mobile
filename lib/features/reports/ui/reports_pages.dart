            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Gastos por categoria — ${month.month}/${month.year}',
                    ...
                    SizedBox(
                      ...
                      child: BarChart(
                        BarChartData(
                          maxY: (barItems.isEmpty ? 0 : barItems.first.value) * 1.15,
                    ...
                    return Padding(
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          radius: 12,
                          backgroundColor:
                          (c?.color ?? Colors.grey).withOpacity(0.2),
                          child: Icon(
